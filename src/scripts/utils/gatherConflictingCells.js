...
export function gatherConflictingCells(digit, i) {
    ...
    for (let j = 0; j < 9; j++) {
        ...
        if (rowCell.textContent.includes(String(digit)) && !rowCell.classList.contains('center-text') && !rowCell.classList.contains('corner-text')) rowCells.push(rowCell);
        if (colCell.textContent.includes(String(digit)) && !colCell.classList.contains('center-text') && !colCell.classList.contains('corner-text')) colCells.push(colCell);
        if (boxCell.textContent.includes(String(digit)) && !boxCell.classList.contains('center-text') && !boxCell.classList.contains('corner-text')) boxCells.push(boxCell);
